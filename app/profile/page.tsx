      ...
      <div className="bg-white dark:bg-slate-800/50 backdrop-blur-xl border-y sm:border border-gray-200 dark:border-slate-700/50 rounded-none sm:rounded-3xl p-4 sm:p-8 shadow-lg mb-6">
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4">
            ...
            <div className="bg-gray-50 dark:bg-slate-700/30 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center">
              <p className="text-xs sm:text-sm text-gray-600 dark:text-slate-400">Locked Posts</p>
              <p className="text-lg sm:text-2xl font-bold text-purple-600 dark:text-purple-400">
                {posts.filter(p => p.isLocked || p.price).length}
              </p>
            </div>
            <div className="bg-gray-50 dark:bg-slate-700/30 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center">
              <p className="text-xs sm:text-sm text-gray-600 dark:text-slate-400">Total Views</p>
